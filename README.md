...
> **Deploying on EasyPanel?** Paste-able EasyPanel templates wrap these
> cron-tab images for one-click deploy — env form plus a file mount that
> overrides the schedule. See [`easypanel/`](./easypanel/README.md).
